...
export const body: string[] = [
  ...
  'I am Portuguese, based in Berlin, and looking for product leadership roles — ideally where AI is doing real work in the product rather than sitting in the pitch deck.',
];
